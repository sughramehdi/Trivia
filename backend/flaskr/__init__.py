...
def create_app(test_config=None):
    ...
    def retrieve_categories():
        try:
            ...
            return jsonify({
                ...
                # returns a list with each category as a seaparate dictionary
                # object
    ...
    def search_questions():
        ...
        try:
            ...
            # all 14 will be shown on page 1 and clicking on page 2
            # will show result of GET /questions?page=2
